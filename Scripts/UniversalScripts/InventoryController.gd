...
func _ready():
	inventory.push_back(new_weapon_add("fists", "put 'em up", "LightPunch", "HeavyPunch", "JugglePunch")) # heavy, no looping
	inventory.push_back(new_weapon_add("knife", "it's a knife", "LightKnife", "", "")) # light, no looping
